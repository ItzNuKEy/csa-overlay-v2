...
**Important:** Make sure `.env` is in your `.gitignore` file (it should be by default) to avoid committing your secrets to version control.
...
- Make sure you've set `DISCORD_CLIENT_ID` and `DISCORD_CLIENT_SECRET` environment variables
